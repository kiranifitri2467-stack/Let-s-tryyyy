...
const DEFAULT_PRODUCTS = [
  ...
  { id:11, name:"Blind Box Fantasy Garden", category:"blindbox", price:95000, stock:14, icon:"🌸", image:"image/cat-blindbox.svg",
...
function bindLetterSection(){
  ...
  function openLetter(){
    ...
    // stagger fade-in tiap baris teks surat
    lines.forEach((line, i)=>{
      line.style.transitionDelay = reduceMotion ? "0ms" : `${420 + i * 22}ms`;
    });
